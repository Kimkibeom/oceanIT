...
<body>
	<ul>
		<li><a href="/controller/DepartmentBoard.do?no=1">학과소개</a></li>
		<li><a href="/controller/ProfessorIntro.do?no=2">교수소개</a></li>
		<li><a href="/controller/Curriculum.do?no=3">교과과정</a></li>
		<li><a
